...
def preprocess_data(df):
    ...
    # Target variable
    y = (data['match_winner'] == data['team_1']).astype(int)
    ...
    categorical_cols = ['venue', 'city', 'team_1', 'team_2', 'toss_winner', 'toss_decision']
